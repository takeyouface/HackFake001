...
def MergeMaskedFace (predictor_func, predictor_input_shape,
    ...
    if cfg.mask_mode == 1: #dst
    ...
    elif cfg.mask_mode >= 6 and cfg.mask_mode <= 10:
        ...
        if cfg.mask_mode == 6:   #FAN-prd
            wrk_face_mask_a_0 = FAN_prd_face_mask_a_0
        elif cfg.mask_mode == 7: #FAN-dst
            wrk_face_mask_a_0 = FAN_dst_face_mask_a_0
        elif cfg.mask_mode == 8:
            wrk_face_mask_a_0 = FAN_prd_face_mask_a_0 * FAN_dst_face_mask_a_0
        elif cfg.mask_mode == 9:
            wrk_face_mask_a_0 = prd_face_mask_a_0 * FAN_prd_face_mask_a_0 * FAN_dst_face_mask_a_0
        elif cfg.mask_mode == 10:
            wrk_face_mask_a_0 = prd_face_mask_a_0 * FAN_dst_face_mask_a_0
    elif cfg.mask_mode >= 11 and cfg.mask_mode <= 14:  #XSeg modes
        if cfg.mask_mode == 11 or cfg.mask_mode == 13 or cfg.mask_mode == 14:
            # obtain XSeg-prd
        ...
        if cfg.mask_mode >= 12 and cfg.mask_mode <= 14:
            # obtain XSeg-dst
        ...
        if cfg.mask_mode == 11:   #'XSeg-prd'
            wrk_face_mask_a_0 = X_prd_face_mask_a_0
        elif cfg.mask_mode == 12: #'XSeg-dst'
            wrk_face_mask_a_0 = X_dst_face_mask_a_0
        elif cfg.mask_mode == 13: #'XSeg-prd*XSeg-dst'
            wrk_face_mask_a_0 = X_prd_face_mask_a_0 * X_dst_face_mask_a_0
        elif cfg.mask_mode == 14: #learned-prd*learned-dst*XSeg-prd*XSeg-dst
