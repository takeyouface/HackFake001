if __name__ == "__main__":
    ...
    if sys.version_info[0] < 3 or (sys.version_info[0] == 3 and sys.version_info[1] < 6):
        raise Exception("此程序需要在Python 3.6及以上版本中运行！")
    ...
    p.add_argument('--model', required=True, dest="model_name", choices=pathex.get_all_dir_names_startswith ( Path(__file__).parent / 'mode1s' , 'Model_'), help="Model class name.")
    ...
    p = xseg_parser.add_parser( "fetch", help="Copies faces containing XSeg polygons in EDIT dir.")
